...
/*
**	M00_Base_Defense is not here.
**
**	It is the all-defaults member of the forty-eight-strong base defence
**	family the 4.8.4 library brought, so it lives with the other forty-seven
**	in Code/Scripts/TT_Defenses.cpp, answering to JFW_Base_Defence as well.
*/
