...
enum {
	...
	CHUNKID_GAME_OBJECT_DEF_CONSTRUCTION_YARD,

	CHUNKID_GAME_OBJECT_SUPERWEAPON,
	CHUNKID_GAME_OBJECT_DEF_SUPERWEAPON,

	CHUNKID_GAME_OBJECT_AIR_FACTORY,
	CHUNKID_GAME_OBJECT_DEF_AIR_FACTORY,

	CHUNKID_GAME_OBJECT_NAVAL_FACTORY,
	CHUNKID_GAME_OBJECT_DEF_NAVAL_FACTORY,
...
enum {
	...
	CLASSID_GAME_OBJECT_DEF_CONSTRUCTION_YARD,
	CLASSID_GAME_OBJECT_DEF_SUPERWEAPON,
	CLASSID_GAME_OBJECT_DEF_AIR_FACTORY,
	CLASSID_GAME_OBJECT_DEF_NAVAL_FACTORY,
