...
enum
{
	...
	NETCLASSID_SCSCRIPTCOMMANDEVENT,
	NETCLASSID_SCMAPQUERYEVENT,
	NETCLASSID_SCSCREENSHOTREQUESTEVENT,
	...
	NETCLASSID_CSSCRIPTKEYEVENT,
	NETCLASSID_CSMAPQUERYRESPONSEEVENT,
	NETCLASSID_CSSCREENSHOTRESULTEVENT,
};
