...
protected:
	...
	////////////////////////////////////////////////////////////////	
	WideStringClass				Title; // 0020  0034
	RectClass						Rect; // 0024  0038
	int								DialogResID; // 0034  0048
	CONTROL_LIST					ControlList; // 0038  004C
	DIALOG_LIST						ChildDialogList; // 0050  0064
	DialogControlClass *			LastFocusControl; // 0068  007C
	bool								IsVisible; // 006C  0080
	bool								AreControlsHidden; // 006D  0081
	bool								IsRunning; // 006E  0082
	int								LastMouseClickTime; // 0070  0084

	static REF_DECL1(DefaultCmdHandler, DEFAULT_DLG_CMD_HANDLER);
}; // 0074  0088
