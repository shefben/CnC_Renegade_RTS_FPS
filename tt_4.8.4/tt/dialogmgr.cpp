...
////////////////////////////////////////////////////////////////
REF_DEF1(DialogMgrClass::FocusControl, DialogControlClass*, 0x0082FFA0);
REF_DEF1(DialogMgrClass::Input, WWUIInputClass*, 0x0082FFA4);
REF_DEF1(DialogMgrClass::InputCapture, DialogControlClass*, 0x0082FF9C);
REF_DEF1(DialogMgrClass::ActiveDialog, DialogBaseClass*, 0x0082FF98);
REF_DEF1(DialogMgrClass::Transition, DialogTransitionClass*, 0x0082FFA8);
REF_DEF1(DialogMgrClass::DialogList, DynamicVectorClass<DialogBaseClass *>, 0x0082FE68);
...
REF_ARR_DEF1(DialogMgrClass::KeyboardState, BYTE, 256, 0x0082FE90);
Vector3											DialogMgrClass::LastMousePos (0, 0, 0);
bool												DialogMgrClass::LastMouseButtonState[MB_COUNT] = { 0 };
REF_DEF1(DialogMgrClass::PendingActiveDialog, DialogBaseClass*, 0x0082FFAC);
REF_DEF1(DialogMgrClass::TransitionDialog, DialogBaseClass*, 0x0082FFB0);
REF_DEF1(DialogMgrClass::CurrTime, uint32, 0x0082FFB4);
REF_DEF1(DialogMgrClass::LastFrameTime, uint32, 0x0082FFB8);
...
RENEGADE_FUNCTION
void ToolTipMgrClass::Initialize()
AT1(0x0050B100);
RENEGADE_FUNCTION
void cGameData::Onetime_Init()
AT1(0x00471720);
void DialogMgrClass::Init2()
{
