...
public:
	...
	// added functions
	//
	int					Get_Scroll_Pos() {return ScrollPos;}
	ScrollBarCtrlClass& Get_Scroll_Bar() {return ScrollBarCtrl;}
	void				Set_Scroll_Pos(int scrollpos) {ScrollPos = scrollpos;}
	void				Update_Scroll_Bar_Visibility (void); //moved here since we need to call it
