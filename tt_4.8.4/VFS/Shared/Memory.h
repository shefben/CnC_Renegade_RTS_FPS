...
typedef void*	(SHARED_CALL fnAllocator)(size_t size);
typedef void	(SHARED_CALL fnFreeer)(void* pMemory);
typedef void*	(SHARED_CALL fnReallocator)(void *pMem, size_t size);

void SetMemoryFunctions(fnAllocator *pfnAllocator, fnFreeer *pfnFreeer, fnReallocator *pfnReallocator);
extern fnAllocator*		g_pAllocator;
extern fnFreeer*		g_pFreeer;
extern fnReallocator*	g_pReallocator;
